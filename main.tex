...
%%     ∂(x₇)(t) == u₂(t) * cos(x₇(t)) / cos(x₈(t)) +
%%       u₃(t) * sin(x₇(t)) / cos(x₈(t))
%%     ∂(x₈)(t) ==-u₂(t) * sin(x₇(t)) + u₃(t) * cos(x₇(t))
%%     ∂(x₉)(t) == u₂(t) * cos(x₇(t)) * tan(x₈(t)) +
%%       u₃(t) * sin(x₇(t)) * tan(x₈(t)) + u₄(t)
%% 
%%     dt1 = sin(2π * t / T)
%%     dt3 = 2sin(4π * t / T)
%%     dt5 = 2t / T
%% 
%%     0.5∫( (x₁(t) - dt1)^2 + (x₃(t) - dt3)^2 +
%%       (x₅(t) - dt5)^2 + x₇(t)^2 + x₈(t)^2 +
%%       x₉(t)^2 + r *
%%       (u₁(t)^2 + u₂(t)^2 + u₃(t)^2 + u₄(t)^2) ) → min
%% 
%% end
%% \end{minted}

\section{GPU detailed configurations}

\noindent Configuration for the A100 runs:
