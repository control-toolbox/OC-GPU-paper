...
\begin{answer}
  \begin{itemize}
    ...
    \item Outlined upcoming work and research questions arising from the connection between these packages, such as solving batch optimization problems with varying initial conditions in optimal control problems.
  \end{itemize}
\end{answer}
